...
STRIP_PREFIX = "<RVSPEC_ROOT>/SpecSynthesis/doc/cFS_doc"
INPUT_JSONL = Path("split_sections/split_sections-cFS.jsonl")
PROMPT_PATH = Path("prompts/prompt_for_logic_policies.txt")
OUTPUT_BASE_DIR = Path("logic_policies-cFS")
...
def setup_logging():
    ...
    log_file = log_dir / f"processing_cFS__{timestamp}.log"
